    ...
    <Layout title='Volunteer | Delray Locals'>
      <section className='pt-24 pb-14 px-4 lg:px-0'>
        ...
        <div className="max-w-[900px] mx-auto">
          ...
          <p className="mt-2">If you would like to add your organization to this list please contact us at <a className="text-blue-500 hover:text-blue-700 transition-all ease-in" href="mailto:hello@delraylocals.com">hello@delraylocals.com</a></p>
        </div>
